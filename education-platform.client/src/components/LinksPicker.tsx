...
const LinksPicker: React.FC<LinksPickerProps> = observer(
    ({ onLinkAdd, error, onLinkDelete, links }) => {
                            ...
                            <Grid key={index} xs={12}>
                                <Paper variant="outlined" sx={{ overflow: 'hidden' }}>
                                    ...
                                    >
                                        ...
                                        <IconButton onClick={() => onLinkDelete(index)}>
                                            <Delete />
                                        </IconButton>
                                    </Stack>
                                </Paper>
                ...
                >
                    ...
                    >
                        ...
                        <Stack direction="row" width="100%" justifyContent="end">
                            <Button color="inherit" onClick={store.handleClose}>
                                {t('common.close')}
                            </Button>
                            <Button
                                color="primary"
