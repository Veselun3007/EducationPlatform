...
namespace StudentResult.Infrastructure.AWS {
    public class AmazonS3 {
        ...
        public static async Task<byte[]> GetObjectAsync(string access_key, string secret_key, string bucket_name, string object_name, RegionEndpoint region = null) {
            AmazonS3Config config = new AmazonS3Config() { RegionEndpoint = region ?? RegionEndpoint.USEast1 };
        ...
        public async Task<bool> PostObjectAsync(string object_name, IFormFile file) {
            if (_client == null) throw new ArgumentNullException();
            return await PostObjectAsync(_client, _bucket, object_name, file);
        }
        #endregion
        ...
        public async Task<bool> DeleteObjectAsync(string object_name) {
            if (_client == null) throw new ArgumentNullException();
            return await DeleteObjectAsync(_client, _bucket, object_name);
        }
        #endregion
